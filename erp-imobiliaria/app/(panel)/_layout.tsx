    ...
    <S.MainContainer isMobile={isMobile}>
      ...
      {!isMobile && (
        <S.SidebarContainer>
          ...
          <SidebarItem icon={<LayoutDashboard size={20} />} label="Dashboard" active={isActive('/')} onPress={() => router.push('/')} />
          <SidebarItem icon={<Home size={20} />} label="Imóveis" active={isActive('/imoveis')} onPress={() => router.push('/imoveis/imoveis')} />
          <SidebarItem icon={<Users size={20} />} label="Clientes" active={isActive('/clientes')} onPress={() => router.push('/clientes/clientes')} />
